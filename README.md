...
```
cd existing_repo
git remote add origin https://gitlab.arbisoft.com/village/slack_bot.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.arbisoft.com/village/slack_bot/-/settings/integrations)
